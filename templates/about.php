...
<header class="inner-page-banner">
    ...
    <div class="banner-image-block">
        <img src="<?php t(); ?>/images/about-hero.png" alt="about page banner">
    </div>
    <div class="banner-title-block">
        <h1>All women <br>All love. </h1>
    </div>
